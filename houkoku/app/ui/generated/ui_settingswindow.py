...
class Ui_SettingsWindow:
    ...
    def setupUi(self, dialog: QDialog) -> None:
        ...
        self.btn_add_report.setAutoDefault(False)
        self.btn_edit_report = QPushButton("編集")
        self.btn_edit_report.setAutoDefault(False)
        self.btn_delete_report = QPushButton("削除")
        self.btn_delete_report.setAutoDefault(False)
        ...
        self.btn_add_dept.setAutoDefault(False)
        self.btn_edit_dept = QPushButton("編集")
        self.btn_edit_dept.setAutoDefault(False)
        self.btn_delete_dept = QPushButton("削除")
        self.btn_delete_dept.setAutoDefault(False)
        ...
        self.btn_save_perms.setAutoDefault(False)
        ...
        self.btn_browse_internal.setAutoDefault(False)
        ...
        self.btn_browse_external.setAutoDefault(False)
